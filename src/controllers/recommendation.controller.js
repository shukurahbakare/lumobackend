...
const Recommendations = require('../models/solarRecommendations.model');
...
exports.getRecommendations = async (req, res) => {
  try {
    ...
    const solarPackages = await Recommendations.find();
    ...
    res.status(200).json({ recommendations, totalPower });
  } catch (error) {
